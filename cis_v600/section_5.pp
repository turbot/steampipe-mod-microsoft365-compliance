...
benchmark "cis_v600_5_1_6" {
  title = "5.1.6 External Identities"
  children = [
  ]

  tags = merge(local.cis_v600_5_1_6_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}

benchmark "cis_v600_5_1_8" {
  title = "5.1.8 Hybrid management"
  children = [
  ]

  tags = merge(local.cis_v600_5_1_8_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}
