locals {
  cis_v600_1_common_tags = merge(local.cis_v600_common_tags, {
    cis_section_id = "1"
  })
}

locals {
  cis_v600_1_1_common_tags = merge(local.cis_v600_1_common_tags, {
    cis_section_id = "1.1"
  })
}

locals {
  cis_v600_1_2_common_tags = merge(local.cis_v600_1_common_tags, {
    cis_section_id = "1.2"
  })
}

locals {
  cis_v600_1_3_common_tags = merge(local.cis_v600_1_common_tags, {
    cis_section_id = "1.3"
  })
}
...
benchmark "cis_v600_1" {
  ...
  documentation = file("./cis_v600/docs/cis_v600_1.md")
  children = [
    benchmark.cis_v600_1_1,
    benchmark.cis_v600_1_2,
    benchmark.cis_v600_1_3
  ]

  tags = merge(local.cis_v600_1_common_tags, {
    type    = "Benchmark"
...
control "cis_v600_1_1_1" {
  ...
  documentation = file("./cis_v600/docs/cis_v600_1_1_1.md")
...
control "cis_v600_1_1_3" {
  ...
  documentation = file("./cis_v600/docs/cis_v600_1_1_3.md")
...
control "cis_v600_1_2_1" {
  ...
  documentation = file("./cis_v600/docs/cis_v600_1_2_1.md")
...
control "cis_v600_1_3_1" {
  title         = "1.3.1 Ensure the 'Password expiration policy' is set to 'Set passwords to never expire (recommended)'"
  ...
  documentation = file("./cis_v600/docs/cis_v600_1_3_1.md")
...
control "cis_v600_1_3_3" {
  ...
  documentation = file("./cis_v600/docs/cis_v600_1_3_3.md")
