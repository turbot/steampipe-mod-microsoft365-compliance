...
locals {
  cis_v300_1_3_common_tags = merge(local.cis_v300_1_common_tags, {
    cis_section_id = "1.3"
  })
}
...
control "cis_v300_1_1_4" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_1_1_4.md")
...
control "cis_v300_1_2_1" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_1_2_1.md")
...
control "cis_v300_1_3_1" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_1_3_1.md")
