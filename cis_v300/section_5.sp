...
locals {
  cis_v300_5_1_1_common_tags = merge(local.cis_v300_5_1_common_tags, {
    cis_section_id = "5.1.1"
  })
}

locals {
  cis_v300_5_1_2_common_tags = merge(local.cis_v300_5_1_common_tags, {
    cis_section_id = "5.1.2"
  })
}

locals {
  cis_v300_5_1_5_common_tags = merge(local.cis_v300_5_1_common_tags, {
...
locals {
  cis_v300_5_2_2_common_tags = merge(local.cis_v300_5_2_common_tags, {
    cis_section_id = "5.2.2"
  })
}

locals {
  cis_v300_5_2_4_common_tags = merge(local.cis_v300_5_2_common_tags, {
    cis_section_id = "5.2.4"
  })
}

locals {
  cis_v300_5_2_6_common_tags = merge(local.cis_v300_5_2_common_tags, {
...
benchmark "cis_v300_5_1_1" {
  ...
  tags = merge(local.cis_v300_5_1_1_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}
...
control "cis_v300_5_1_1_1" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_1_1_1.md")
...
benchmark "cis_v300_5_1_2" {
  ...
  tags = merge(local.cis_v300_5_1_2_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}
...
control "cis_v300_5_1_2_2" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_1_2_2.md")
...
benchmark "cis_v300_5_1_5" {
  ...
  tags = merge(local.cis_v300_5_1_5_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}
...
control "cis_v300_5_1_5_3" {
  title         = "5.1.5.3 Ensure the admin consent workflow is enabled"
...
benchmark "cis_v300_5_2_2" {
  ...
  children = [
    ...
    control.cis_v300_5_2_2_3,
    control.cis_v300_5_2_2_4,
    control.cis_v300_5_2_2_6,
    control.cis_v300_5_2_2_7,
    control.cis_v300_5_2_2_8
  ]

  tags = merge(local.cis_v300_5_2_2_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}
...
control "cis_v300_5_2_2_1" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_2_2_1.md")
...
control "cis_v300_5_2_2_2" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_2_2_2.md")
...
control "cis_v300_5_2_2_3" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_2_2_3.md")
...
control "cis_v300_5_2_2_4" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_2_2_4.md")
...
control "cis_v300_5_2_2_6" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_2_2_6.md")
...
control "cis_v300_5_2_2_7" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_2_2_7.md")
...
control "cis_v300_5_2_2_8" {
  ...
  documentation = file("./cis_v300/docs/cis_v300_5_2_2_8.md")
