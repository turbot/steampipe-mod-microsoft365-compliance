...
locals {
  cis_v500_1_1_common_tags = merge(local.cis_v500_1_common_tags, {
    cis_section_id = "1.1"
  })
}

locals {
  cis_v500_1_2_common_tags = merge(local.cis_v500_1_common_tags, {
    cis_section_id = "1.2"
  })
}

locals {
  cis_v500_1_3_common_tags = merge(local.cis_v500_1_common_tags, {
    cis_section_id = "1.3"
  })
}
...
benchmark "cis_v500_1" {
  ...
  children = [
    benchmark.cis_v500_1_1,
    benchmark.cis_v500_1_2,
    benchmark.cis_v500_1_3
...
benchmark "cis_v500_1_1" {
  title = "1.1 Users"
  children = [
    control.cis_v500_1_1_1,
    control.cis_v500_1_1_3
  ]

  tags = merge(local.cis_v500_1_1_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}
...
control "cis_v500_1_1_1" {
  ...
  query         = query.azuread_administrative_account_on_premises_sync_disabled
  documentation = file("./cis_v500/docs/cis_v500_1_1_1.md")
...
control "cis_v500_1_1_3" {
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_1_3.md")
...
benchmark "cis_v500_1_2" {
  ...
  children = [
    control.cis_v500_1_2_1
  ]

  tags = merge(local.cis_v500_1_2_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}
...
control "cis_v500_1_2_1" {
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_2_1.md")
...
benchmark "cis_v500_1_3" {
  title = "1.3 Settings"
  children = [
    control.cis_v500_1_3_1,
    control.cis_v500_1_3_3
  ]

  tags = merge(local.cis_v500_1_3_common_tags, {
    type    = "Benchmark"
    service = "Azure/ActiveDirectory"
  })
}
...
control "cis_v500_1_3_1" {
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_3_1.md")
...
control "cis_v500_1_3_3" {
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_3_3.md")
